                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="card col-md-8 shadow bg-white rounded">
                            ...
                            <div class="card-body">
                                <form action="<?=BASEURL ;?>/donatur/updatepassword" method="post">
                                    <div class="mb-4">
                                        <label for="id" class="form-label">Id Masjid</label>
                                        <input type="text" name="id"  class="form-control" value="<?=ucwords($data['profile'])  ;?>" id="id" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label for="oldpassword" class="form-label">Password Saat ini</label>
                                        <input type="password" maxlength="64" name="oldpassword" class="form-control" id="password" autocomplete="off" required>
                                    </div>
                                    <div class="mb-4">
